...
-- -----------------------------------------------------
-- Table `new_trainogram`.`user_has_friends`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `new_trainogram`.`user_has_friends` ;

CREATE TABLE IF NOT EXISTS `new_trainogram`.`user_has_friends` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
  `friend_id` INT NOT NULL,
  `friend_status` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_user_has_friends_user1_idx` (`user_id` ASC) VISIBLE,
  INDEX `fk_user_has_friends_user2_idx` (`friend_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `new_trainogram`.`event_friendship`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `new_trainogram`.`event_friendship` ;

CREATE TABLE IF NOT EXISTS `new_trainogram`.`event_friendship` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_EventFriendship_user1_idx` (`owner_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `new_trainogram`.`event_post`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `new_trainogram`.`event_post` ;

CREATE TABLE IF NOT EXISTS `new_trainogram`.`event_post` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `owner_id` INT NOT NULL,
  `creator_id` INT NOT NULL,
  `post_id` INT NOT NULL,
  ...
  `event_status` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_notification_post_user1_idx` (`owner_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `new_trainogram`.`event_comment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `new_trainogram`.`event_comment` ;

CREATE TABLE IF NOT EXISTS `new_trainogram`.`event_comment` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `owner_id` INT NOT NULL,
  `creator_id` INT NOT NULL,
  `comment_id` INT NOT NULL,
  ...
  `event_status` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_notifiication_comment_user1_idx` (`owner_id` ASC) VISIBLE,
