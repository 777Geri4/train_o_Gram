...
public class LikePostServiceImpl implements LikeService {
    ...
    @Autowired
    public LikePostServiceImpl(LikePostRepository likePostRepository, UserServiceImpl userServiceImpl, PostServiceImpl postServiceImpl) {
    ...
    public void save(int postId) {
        ...
        likePostRepository.save(new LikePost(userServiceImpl.getCurrentUser(), postServiceImpl.updatePost(post)));
    }
    ...
    public void delete(int postId) {
        ...
        int postLikes = post.getLikes();
        post.setLikes(--postLikes);
        likePostRepository.delete(new LikePost(userServiceImpl.getCurrentUser(), postServiceImpl.updatePost(post)));
    }
}