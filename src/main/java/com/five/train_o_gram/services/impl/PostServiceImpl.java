...
import com.five.train_o_gram.services.PictureService;
...
public class PostServiceImpl implements PostService {
    ...
    public PostServiceImpl(PostRepository postRepository, ImageService imageService,
                           PictureService pictureService, CommentServiceImpl commentServiceImpl) {
    ...
    private List<CommentDTO> convertListOfCommentsToListOfCommentsDTO(List<Comment> comments){
        return comments.stream().map(commentServiceImpl::convertCommentToCommentDTO).toList();
    }
}